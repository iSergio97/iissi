...
<body>
	<script>
	//Con esto consigo copiar el email en el campo del nickname a la misma vez que vamos escribiendo el primero
		...
		// Inicialización de elementos y eventos cuando el documento se carga completamente
			...
			$("#provincia").on('input', function(){
				//esto depende de si la llamada es get o post en el formulario
				$.get("gestionar_direcciones.php",
							{provincia:$(this).val()},
							function(data){
	...
	<form id="altaUsuario" method="get" action="accion_alta_usuario.php" onsubmit="return validateForm()">
		...
		<fieldset>
			...
			<!-- EJERCICIO 4: Listar los municipios que haya en la BD de la provincia seleccionada-->
			<!--
